  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-8">
      <article className="lg:col-span-4 rounded-xl bg-[#dce8ea] border border-[#c4d4d8] p-6 min-h-[220px] flex flex-col justify-between">
        <div>
          <p className="text-4xl font-semibold tracking-tight text-slate-700 leading-tight">Place</p>
          <p className="text-4xl font-semibold tracking-tight text-slate-700 leading-tight">Holder</p>
          <p className="text-5xl font-bold tracking-tight text-slate-700 leading-tight">test</p>
        </div>
      ...
      <article className="lg:col-span-8 rounded-xl bg-gradient-to-r from-[#eceff2] via-[#e8edf0] to-[#d7c7ef] border border-[#e0e6ea] p-6 min-h-[220px] flex flex-col justify-between overflow-hidden relative">
        ...
        <div className="relative">
          <h2 className="text-5xl font-extrabold tracking-tight text-slate-700">Test</h2>
          <p className="mt-2 text-3xl text-slate-600">Test2</p>
        </div>
